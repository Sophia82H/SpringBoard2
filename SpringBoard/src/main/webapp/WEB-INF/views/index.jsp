...
<body data-bs-spy="scroll" data-bs-target="#navbarExample">
    ...
    <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="index"><img src="resources/images/logo2.svg" alt="alternative" >Spring Board</a> 
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <!--  
                     ...
                     -->
                        <a class="nav-link " href="#projects" >게시판</a>
                        <!--  
                        <ul class="dropdown-menu" aria-labelledby="dropdown01">
                            <li><a class="dropdown-item" href="article.html">최신순</a></li>
                            <li><div class="dropdown-divider"></div></li>
                            <li><a class="dropdown-item" href="terms.html">주제별</a></li>
                            <li><div class="dropdown-divider"></div></li>
                            <li><a class="dropdown-item" href="privacy.html">작성자</a></li>
                        </ul>
                        -->
                    </li>
                </ul>
                <span class="nav-item">
                    <a class="btn-solid-sm" href="/Login/LoginMain">로그인</a>
                </span>
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        <div class="section-title">봄 소식에 오신걸 환영합니다.</div>
                        ...
                        <a class="quote" href="#contact"><i class="fas fa-paper-plane"></i>로그인</a>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="resources/images/header-illustration.svg" alt="alternative">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="button-group filters-button-group">
                        ...
                        <button class="button" data-filter=".design">최신순</button>
                        <button class="button" data-filter=".development">작성자별</button>
                        <button class="button" data-filter=".marketing">주제별</button>
                    </div> <!-- end of button group -->
                    <div class="grid">
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="resources/images/project-1.jpg" alt="alternative">
                                <p><strong>Online banking</strong> - pellentesque tincidunt leo eu laoreedt integer quis vanos compren</p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="resources/images/project-2.jpg" alt="alternative">
                                <p><strong>Loans company</strong> - odio semper, interdum orci molestie, mattis lectus pellentesq aliqu</p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="resources/images/project-3.jpg" alt="alternative">
...
--%>
    ...
    <div class="footer bg-gray">
        <img class="decoration-city" src="resources/images/decoration-city.svg" alt="alternative">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
